...
const SingleProduct = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={singleProduct.image} />
...
export const singleProductLoader = async ({params})=>{
  ...
  const individualProduct = await fetch("https://fakestoreapi.com/products/" + id);
  if(!individualProduct.ok){
    throw Error("Error while loading single product")
  }
  return individualProduct.json();
}
